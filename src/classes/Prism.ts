...
import { cubeFragmentShader, prismFragmentShader } from "../shader/fragment";
import { degToRad } from "../utils/rotate-utils";
import Shape from "./Shape";
import { PrismDefault } from "../constant";
...
export default class Prism extends Shape {
  ...
  constructor(canvas: HTMLCanvasElement, gl: WebGL2RenderingContext) {
    super(canvas, gl, cubeVertexShader, prismFragmentShader);
    const vertices = [
        -1,-1,-1, 
        1,-1,-1, 
        1, 1,-1,
    ...
    // console.log(vector.normal(-1, -1, -1, 1, 1, 1, -1, 1, 1))
  ...
  loadDefaults() {
    this.programInfo.uTranslation.value = PrismDefault.uTranslation
    this.programInfo.uScale.value = PrismDefault.uScale
    this.programInfo.uRotation.value = PrismDefault.uRotation
  }
